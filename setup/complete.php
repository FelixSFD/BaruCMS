...
<body>
	<div id="main">
		<div id="top">
			<p align=right>Installationsfortschritt <span id="prozent">100%</span></p>
			<span id="s1DL"></span>
		</div>
		<div id="content">
			<div id="logo">
	...
	<div id="footer">
		<small>&copy; Felix Deil 2012-2013 - Installer-Version: 1.0.2 - Baru CMS version: 0.4.1</small>
	</div>
</body>
</html>
<?php
rename("../setup.php", "../setup.php.bak");
?>